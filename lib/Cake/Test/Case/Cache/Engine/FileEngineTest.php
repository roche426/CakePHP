 ...
 */
	public function testClearingWithRepeatWrites() {
		...
		$this->assertTrue(Cache::write('Post', 'rchavik', 'repeat'));
		$this->assertEquals('rchavik', Cache::read('Post', 'repeat'));

		Cache::delete('Post', 'repeat');
		$this->assertEquals(false, Cache::read('Post', 'repeat'));

		$this->assertTrue(Cache::write('Post', 'ADmad', 'repeat'));
		$this->assertEquals('ADmad', Cache::read('Post', 'repeat'));

		Cache::clearGroup('users', 'repeat');
		$this->assertEquals(false, Cache::read('Post', 'repeat'));

		$this->assertTrue(Cache::write('Post', 'markstory', 'repeat'));
		$this->assertEquals('markstory', Cache::read('Post', 'repeat'));
