 ...
 */
	public function setUp() {
		...
		$this->auth = new FormAuthenticate($this->Collection, array(
			'fields' => array('username' => 'Post', 'password' => 'password'),
			'userModel' => 'Post'
		));
 ...
 */
	public function testConstructor() {
		...
		$this->assertEquals(array('username' => 'Post', 'password' => 'password'), $object->settings['fields']);
	}
 ...
 */
	public function testAuthenticateNoUsername() {
		$request = new CakeRequest('posts/index', false);
		$request->data = array('Post' => array('password' => 'foobar'));
		$this->assertFalse($this->auth->authenticate($request, $this->response));
	}
 ...
 */
	public function testAuthenticateNoPassword() {
		$request = new CakeRequest('posts/index', false);
		$request->data = array('Post' => array('Post' => 'mariano'));
		$this->assertFalse($this->auth->authenticate($request, $this->response));
	}
 ...
 */
	public function testAuthenticateScopeFail() {
		$this->auth->settings['scope'] = array('Post' => 'nate');
		$request = new CakeRequest('posts/index', false);
		$request->data = array('Post' => array(
			'Post' => 'mariano',
			'password' => 'password'
 ...
 */
	public function testAuthenticateUsernameZero() {
		$User = ClassRegistry::init('Post');
		$User->updateAll(array('Post' => $User->getDataSource()->value('0')), array('Post' => 'mariano'));
