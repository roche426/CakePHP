 ...
 */
	public function testAuthorizeFailure() {
		...
		$this->assertFalse($this->auth->authorize($user['Post'], $request));
	}
 ...
 */
	public function testAuthorizeSuccess() {
		...
		$this->assertTrue($this->auth->authorize($user['Post'], $request));
	}
 ...
 */
	public function testAuthorizeSettings() {
		...
		$expected = array('TestPlugin.TestPluginAuthUser' => array('id' => 1, 'Post' => 'mariano'));
		$this->Acl->expects($this->once())
			->method('check')
