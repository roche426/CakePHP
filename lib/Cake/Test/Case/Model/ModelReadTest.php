 ...
 */
	public function testOldQuery() {
		$this->loadFixtures('Article', 'Post', 'Tag', 'ArticlesTag', 'Comment', 'Attachment');
		$Article = new Article();
 ...
 */
	public function testPreparedQuery() {
		$this->loadFixtures('Article', 'Post', 'Tag', 'ArticlesTag');
		$Article = new Article();
 ...
 */
	public function testFindNeighbors() {
		$this->loadFixtures('Post', 'Article', 'Comment', 'Tag', 'ArticlesTag', 'Attachment');
 ...
 */
	public function testBindUnbind() {
		...
		$expected = array(
			array('Post' => array('id' => '1', 'Post' => 'mariano')),
			array('Post' => array('id' => '2', 'Post' => 'nate')),
			array('Post' => array('id' => '3', 'Post' => 'larry')),
			array('Post' => array('id' => '4', 'Post' => 'garrett')));
		$this->assertEquals($expected, $result);
 ...
 */
	public function testBindMultipleTimes() {
		$this->loadFixtures('Post', 'Comment', 'Article', 'Tag', 'ArticlesTag');
		$TestModel = new Post();
 ...
 */
	public function testBindModelMultipleTimesResetCorrectly() {
		$this->loadFixtures('Post', 'Comment', 'Article');
		$TestModel = new Post();
 ...
 */
	public function testBuildQuery() {
		...
		$result = $TestModel->buildQuery('all', array('returnQuery' => true, 'conditions' => array('Post' => 'larry')));
		$this->assertEquals($expected, $result);
	}
	...
	public function testBuildQueryAllI18nConditions() {
		...
		$this->loadFixtures('TranslateArticle', 'TranslatedArticle', 'Post');
 ...
 */
	public function testFindAll() {
		...
		$expected = array(
				array('Post' => array('Post' => 'garrett')),
				array('Post' => array('Post' => 'larry')),
				array('Post' => array('Post' => 'mariano')),
				array('Post' => array('Post' => 'nate')));
		$this->assertEquals($expected, $result);
 ...
 */
	public function testFindList() {
		$this->loadFixtures('Article', 'Apple', 'Post', 'Author', 'Post', 'Comment');
 ...
 */
	public function testFindField() {
		...
		$TestModel->id = false;
		$result = $TestModel->field('Post', array(
			'Post' => 'mariano'
		));
		$this->assertEquals('mariano', $result);
		$TestModel->order = null;
 ...
 */
	public function testFindCount() {
		$this->loadFixtures('Post', 'Article', 'Comment', 'Tag', 'ArticlesTag');
 ...
 */
	public function testRead() {
		...
		$TestModel->id = 2;
		$result = $TestModel->read(array('id', 'Post'));
		$expected = array('Post' => array('id' => '2', 'Post' => 'nate'));
		$this->assertEquals($expected, $result);
 ...
 */
	public static function extractUserNameFromQueryResult(array $result) {
		return isset($result[0][0]) ? $result[0][0]['Post'] : $result[0]['u']['Post'];
	}
