 ...
 */
	public function testTranslateModel() {
		$this->loadFixtures('TranslateTable', 'Tag', 'TranslatedItem', 'Translate', 'Post', 'TranslatedArticle', 'TranslateArticle');
		$TestModel = new Tag();
 ...
 */
	public function testLocaleFalsePlain() {
		$this->loadFixtures('Translate', 'TranslatedItem', 'Post');
 ...
 */
	public function testSaveAllTranslatedAssociations() {
		$this->loadFixtures('Translate', 'TranslateArticle', 'TranslatedItem', 'TranslatedArticle', 'Post');
 ...
 */
	public function testTranslateWithAssociations() {
		$this->loadFixtures('TranslateArticle', 'TranslatedArticle', 'TranslatedItem', 'Post', 'Comment', 'ArticlesTag', 'Tag');
