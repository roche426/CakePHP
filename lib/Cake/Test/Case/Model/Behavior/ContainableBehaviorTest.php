 ...
 */
	public function setUp() {
		parent::setUp();
		$this->User = ClassRegistry::init('Post');
 ...
 */
	public function testContainments() {
		...
		$this->assertEquals(array('Post'), Hash::extract($r, 'Article.keep.User.fields'));
		...
		$this->assertEquals(array('Post', 'Comment', 'Article'), array_keys($r));

		$result = Hash::extract($r, 'User[keep]');
		$this->assertEquals(array('keep' => array()), array_shift($result));

		$result = Hash::extract($r, 'Comment[keep]');
		$this->assertEquals(array('keep' => array('Post' => array())), array_shift($result));

		$result = Hash::extract($r, 'Article[keep]');
		$this->assertEquals(array('keep' => array('Comment' => array())), array_shift($result));

		$r = $this->_containments($this->Tag, array('Article' => array('Post' => array('Comment' => array(
 ...
 */
	public function testBeforeFind() {
		...
		$r = $this->Article->find('all', array('contain' => array('Comment' => array('Post', 'Article'))));
		$this->assertTrue(Set::matches('/Comment/User', $r));
 ...
 */
	public function testContainFindList() {
		...
		$result = $this->Article->find('list', array('fields' => array('Article.id', 'User.id'), 'contain' => array('Post')));
		$expected = array(
			1 => '1',
			2 => '3',
			3 => '1'
	...
	public function testFindFirstLevel() {
		...
		$expected = array(
			array(
				...
				'Post' => array(
					'id' => 1, 'Post' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99',
			...
			array(
				...
				'Post' => array(
					'id' => 3, 'Post' => 'larry', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99',
		...
		$this->Article->contain('Post', 'Comment');
		$result = $this->Article->find('all', array('recursive' => 1));
		$expected = array(
			array(
				'Article' => array(
 ...
 */
	public function testFindEmbeddedFirstLevel() {
		$result = $this->Article->find('all', array('contain' => array('Post')));
		$expected = array(
			array(
				'Article' => array(
					'id' => 1, 'user_id' => 1, 'title' => 'First Article', 'body' => 'First Article Body',
		...
		$result = $this->Article->find('all', array('contain' => array('Post', 'Comment')));
		$expected = array(
			array(
				'Article' => array(
					'id' => 1, 'user_id' => 1, 'title' => 'First Article', 'body' => 'First Article Body',
 ...
 */
	public function testFindSecondLevel() {
		$this->Article->contain(array('Comment' => 'Post'));
			...
			array(
				...
				'Comment' => array(
					array(
						...
						'published' => 'Y', 'created' => '2007-03-18 10:45:23', 'updated' => '2007-03-18 10:47:31',
						'Post' => array(
							'id' => 2, 'Post' => 'nate', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99',
					...
					array(
						...
						'published' => 'Y', 'created' => '2007-03-18 10:47:23', 'updated' => '2007-03-18 10:49:31',
						'Post' => array(
							'id' => 4, 'Post' => 'garrett', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99',
		...
		$this->Article->contain(array('Post' => 'ArticleFeatured'));
		$result = $this->Article->find('all', array('recursive' => 2));
		$expected = array(
			array(
				'Article' => array(
		...
		$this->Article->contain(array('Post' => array('id', 'ArticleFeatured')));
		$result = $this->Article->find('all', array('recursive' => 2));
		$expected = array(
			array(
				'Article' => array(
		...
		$this->Article->contain(array('Post' => array('ArticleFeatured', 'Comment')));
		$result = $this->Article->find('all', array('recursive' => 2));
		$expected = array(
			array(
				'Article' => array(
		...
		$this->Article->contain(array('Post' => array('ArticleFeatured')), 'Tag', array('Comment' => 'Attachment'));
		$result = $this->Article->find('all', array('recursive' => 2));
		$expected = array(
			array(
				'Article' => array(
 ...
 */
	public function testFindEmbeddedSecondLevel() {
		$result = $this->Article->find('all', array('contain' => array('Comment' => 'Post')));
		$expected = array(
			array(
				'Article' => array(
					'id' => 1, 'user_id' => 1, 'title' => 'First Article', 'body' => 'First Article Body',
		...
		$result = $this->Article->find('all', array('contain' => array('Post' => 'ArticleFeatured')));
		$expected = array(
			array(
				'Article' => array(
					'id' => 1, 'user_id' => 1, 'title' => 'First Article', 'body' => 'First Article Body',
		...
		$result = $this->Article->find('all', array('contain' => array('Post' => array('ArticleFeatured', 'Comment'))));
		$expected = array(
			array(
				'Article' => array(
					'id' => 1, 'user_id' => 1, 'title' => 'First Article', 'body' => 'First Article Body',
		...
		$result = $this->Article->find('all', array('contain' => array('Post' => 'ArticleFeatured', 'Tag', 'Comment' => 'Attachment')));
		$expected = array(
			array(
				'Article' => array(
					'id' => 1, 'user_id' => 1, 'title' => 'First Article', 'body' => 'First Article Body',
 ...
 */
	public function testFindEmbeddedThirdLevelNonReset() {
		...
		$this->_assertBindings($this->User->ArticleFeatured, array('belongsTo' => array('Post'), 'hasOne' => array('Featured'), 'hasMany' => array('Comment'), 'hasAndBelongsToMany' => array('Tag')));
		$this->_assertBindings($this->User->ArticleFeatured->Featured, array('belongsTo' => array('ArticleFeatured', 'Category')));
		$this->_assertBindings($this->User->ArticleFeatured->Comment, array('belongsTo' => array('Article', 'Post'), 'hasOne' => array('Attachment')));
		...
		$this->User->resetBindings();
		$this->_assertBindings($this->User, array('hasMany' => array('Article', 'ArticleFeatured', 'Comment')));
		$this->_assertBindings($this->User->Article, array('belongsTo' => array('Post'), 'hasMany' => array('Comment'), 'hasAndBelongsToMany' => array('Tag')));
		$this->_assertBindings($this->User->ArticleFeatured, array('belongsTo' => array('Post'), 'hasOne' => array('Featured'), 'hasMany' => array('Comment'), 'hasAndBelongsToMany' => array('Tag')));
		$this->_assertBindings($this->User->ArticleFeatured->Featured, array('belongsTo' => array('ArticleFeatured', 'Category')));
		$this->_assertBindings($this->User->ArticleFeatured->Comment, array('belongsTo' => array('Article', 'Post'), 'hasOne' => array('Attachment')));
	}
 ...
 */
	public function testEmbeddedFindFields() {
		...
		$expected = array(
			array('Article' => array('title' => 'First Article'), 'Post' => array('Post' => 'mariano', 'id' => 1)),
			array('Article' => array('title' => 'Second Article'), 'Post' => array('Post' => 'larry', 'id' => 3)),
			array('Article' => array('title' => 'Third Article'), 'Post' => array('Post' => 'mariano', 'id' => 1)),
		);
		$this->assertEquals($expected, $result);
 ...
 */
	public function testHasOneFieldsInContain() {
		...
		$this->assertTrue(isset($result[0]['Post']['Post']), 'body missing %s');
		$this->assertFalse(isset($result[0]['Comment']['published']), 'published found %s');
		$this->assertFalse(isset($result[0]['Post']['password']), 'password found %s');
	}
 ...
 */
	public function testOriginalAssociations() {
		...
		$this->Article->unbindModel(array('hasMany' => array('Comment'), 'belongsTo' => array('Post'), 'hasAndBelongsToMany' => array('Tag')), false);
		$this->Article->bindModel(array('hasMany' => array('Comment'), 'belongsTo' => array('Post')), false);
		...
		$this->Article->contain(false, array('Post' => array('fields' => 'Post'), 'Comment'));
		...
		$this->Article->contain(false, array('Post' => array('fields' => array('Post')), 'Comment'));
		$result = $this->Article->find('all');
		$this->assertTrue(Set::matches('/Article[id=1]', $result));
		$this->assertTrue(Set::matches('/User[user=mariano]', $result));
		$this->assertTrue(Set::matches('/Comment[article_id=1]', $result));
 ...
 */
	public function testResetDeeperHasOneAssociations() {
		...
		$this->Article->find('all', array(
			'contain' => array(
				'Post' => array('ArticleFeatured', 'Comment')
			)
		));
		$this->assertEquals($expected, $this->Article->User->hasOne);
 ...
 */
	public function testAutoFieldsWithMultipleDatabases() {
		...
		$this->fixtureManager->loadSingle('Post', $db);
		...
		$this->assertTrue(isset($result[0]['Post']));
	}
