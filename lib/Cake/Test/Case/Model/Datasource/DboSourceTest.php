 ...
 */
	public function testMergeAssociations() {
		...
		$expected = array(
			...
			'User2' => array(
				'id' => '1', 'Post' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31'
			)
		);
 ...
 */
	public function testReadOnlyCallingQueryAssociationWhenDefined() {
		$this->loadFixtures('Article', 'Post', 'ArticlesTag', 'Tag');
 ...
 */
	public function testCountAfterFindCalls() {
		...
		$User = $this->getMock('Post', array('afterFind'), array(), '', true);
		...
		$Article->unbindModel(array('belongsTo' => array('Post'), 'hasAndBelongsToMany' => array('Tag')));
		$Comment->unbindModel(array('belongsTo' => array('Post', 'Article'), 'hasOne' => 'Attachment'));
