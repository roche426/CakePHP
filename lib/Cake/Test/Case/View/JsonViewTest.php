 ...
 */
	public static function renderWithoutViewProvider() {
		return array(
			...
			array(
				array('data' => array('Post' => 'fake', 'list' => array('item1', 'item2'))),
				'data',
				json_encode(array('Post' => 'fake', 'list' => array('item1', 'item2')))
			),
			...
			array(
				array('no' => 'nope', 'Post' => 'fake', 'list' => array('item1', 'item2')),
				array('no', 'Post'),
				json_encode(array('no' => 'nope', 'Post' => 'fake'))
			),
			...
			array(
				array('original_name' => 'my epic name', 'Post' => 'fake', 'list' => array('item1', 'item2')),
				array('new_name' => 'original_name', 'Post'),
				json_encode(array('new_name' => 'my epic name', 'Post' => 'fake'))
			),
 ...
 */
	public function testJsonpResponse() {
		...
		$data = array('Post' => 'fake', 'list' => array('item1', 'item2'));
		$Controller->set(array(
			'data' => $data,
			'_serialize' => 'data',
			'_jsonp' => true
 ...
 */
	public function testRenderWithView() {
		...
		$Controller->set('Post', $data);
		$View = new JsonView($Controller);
		$output = $View->render('index');

		$expected = json_encode(array('Post' => 'fake', 'list' => array('item1', 'item2'), 'paging' => null));
		$this->assertSame($expected, $output);
		$this->assertSame('application/json', $Response->type());
	}
 ...
 */
	public function testRenderWithViewAndNamed() {
		...
		$expected = array('Post' => 'fake', 'list' => array('item1', 'item2'), 'paging' => array('page' => 2));
