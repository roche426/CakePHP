	...
	public function testKeyCheck() {
		...
		$data = array(
			array(
				...
				'Post' => array('id' => '1', 'Post' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31'),
				'Comment' => array(
 ...
 */
	public function testMerge() {
		...
		$r = Set::merge('foo', array('Post' => 'bob', 'no-bar'), 'bar');
		$this->assertEquals(array('foo', 'Post' => 'bob', 'no-bar', 'bar'), $r);
 ...
 */
	public function testExtract() {
		$a = array(
			...
			array(
				'Article' => array('id' => '3', 'user_id' => '1', 'title' => 'Third Article', 'body' => 'Third Article Body', 'published' => 'Y', 'created' => '2007-03-18 10:43:23', 'updated' => '2007-03-18 10:45:31'),
				'Post' => array('id' => '2', 'Post' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31'),
				'Comment' => array(),
				'Tag' => array()
			),
			array(
				'Article' => array('id' => '3', 'user_id' => '1', 'title' => 'Third Article', 'body' => 'Third Article Body', 'published' => 'Y', 'created' => '2007-03-18 10:43:23', 'updated' => '2007-03-18 10:45:31'),
				'Post' => array('id' => '3', 'Post' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31'),
				'Comment' => array(),
				'Tag' => array()
			),
			array(
				'Article' => array('id' => '3', 'user_id' => '1', 'title' => 'Third Article', 'body' => 'Third Article Body', 'published' => 'Y', 'created' => '2007-03-18 10:43:23', 'updated' => '2007-03-18 10:45:31'),
				'Post' => array('id' => '4', 'Post' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31'),
				'Comment' => array(),
				'Tag' => array()
			),
			array(
				'Article' => array('id' => '3', 'user_id' => '1', 'title' => 'Third Article', 'body' => 'Third Article Body', 'published' => 'Y', 'created' => '2007-03-18 10:43:23', 'updated' => '2007-03-18 10:45:31'),
				'Post' => array('id' => '5', 'Post' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31'),
				'Comment' => array(),
				'Tag' => array()
			)
		);
		...
		$this->assertEquals('bob', $r[0]['Comment']['Post']['name']);
		$this->assertEquals('dan', $r[1]['Comment']['Post']['name']);
		$this->assertEquals(2, count($r));

		$r = Set::extract('/Comment/User[name=/bob|tod/]/..', $habtm);
		$this->assertEquals('bob', $r[0]['Comment']['Post']['name']);

		$this->assertEquals('tod', $r[1]['Comment']['Post']['name']);
		$this->assertEquals(2, count($r));
		...
		$this->assertEquals('bob', $r[0]['Comment']['Post']['name']);
		$this->assertEquals('tod', $r[1]['Comment']['Post']['name']);
		$this->assertEquals('dan', $r[2]['Comment']['Post']['name']);
		$this->assertEquals('dan', $r[3]['Comment']['Post']['name']);
 ...
 */
	public function testExtractWithNonZeroArrays() {
		...
		$expected = array(
			array('Post' => array('id' => 1, 'name' => 'John')),
			array('Post' => array('id' => 2, 'name' => 'Bob')),
			array('Post' => array('id' => 3, 'name' => 'Tony')),
		);
 ...
 */
	public function testMatches() {
		...
		$this->assertEquals(array('Post'), Set::extract('/Article/keep/User/fields', $r));
	}
	...
	public function testClassicExtract() {
		...
		$a = array(
			array(
				...
				'Post' => array('id' => 1, 'username' => 'mariano.iglesias'))
			),
			array(
			...
			array(
				...
				'Post' => array('id' => 2, 'username' => 'phpnut'))
			)
		);
 ...
 */
	public function testCombine() {
		...
		$a = array(
			array('Post' => array('id' => 2, 'group_id' => 1,
				'Data' => array('Post' => 'mariano.iglesias', 'name' => 'Mariano Iglesias'))),
			array('Post' => array('id' => 14, 'group_id' => 2,
				'Data' => array('Post' => 'phpnut', 'name' => 'Larry E. Masters'))),
			array('Post' => array('id' => 25, 'group_id' => 1,
				'Data' => array('Post' => 'gwoo', 'name' => 'The Gwoo'))));
		...
		$expected = array(
			2 => array('Post' => 'mariano.iglesias', 'name' => 'Mariano Iglesias'),
			14 => array('Post' => 'phpnut', 'name' => 'Larry E. Masters'),
			25 => array('Post' => 'gwoo', 'name' => 'The Gwoo'));
		$this->assertEquals($expected, $result);
 ...
 */
	public function testMapReverse() {
		...
		$expected = array('Post' => array('psword' => 'whatever', 'Icon' => array('id' => 851)));
		$map = Set::map($expected);
		$result = Set::reverse($map);
		$this->assertEquals($expected, $result);
		...
		$expected = array('Post' => array('psword' => 'whatever', 'Icon' => array('id' => 851), 'Profile' => array('name' => 'Some Name', 'address' => 'Some Address')));
		$class = new stdClass;
		$class->User = new stdClass;
		$class->User->psword = 'whatever';
		$class->User->Icon = new stdClass;
		...
		$expected = array('Post' => array('psword' => 'whatever',
						'Icon' => array('id' => 851),
		...
		$result = Set::reverse($class);
		$expected = array('Post' => array('id' => '100'), 'Profile' => array('name' => 'Joe Mamma'));
		$this->assertEquals($expected, $result);
	}
	...
	public function testNestedMappedData() {
		$result = Set::map(array(
				array(
					...
					'Author' => array('id' => '1', 'Post' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31', 'test' => 'working'),
				),
				array(
					...
					'Author' => array('id' => '3', 'Post' => 'larry', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:20:23', 'updated' => '2007-03-17 01:22:31', 'test' => 'working'),
				)
			));
