	...
	public function testFlatten() {
		...
		$data = array(
			array(
				...
				'Author' => array('id' => '1', 'Post' => 'nate', 'password' => 'foo'),
			),
			array(
				'Post' => array('id' => '2', 'author_id' => '3', 'title' => 'Second Post', 'body' => 'Second Post Body'),
				'Author' => array('id' => '3', 'Post' => 'larry', 'password' => null),
			)
		);
		$result = Hash::flatten($data);
		$expected = array(
 ...
 */
	public function testMerge() {
		...
		$result = Hash::merge(array('foo'), array('Post' => 'bob', 'no-bar'), 'bar');
		$this->assertEquals($result, array('foo', 'Post' => 'bob', 'no-bar', 'bar'));
 ...
 */
	public function testCombineErrorMissingValue() {
		$data = array(
			array('Post' => array('id' => 1, 'name' => 'mark')),
			array('Post' => array('name' => 'jose')),
		);
