 ...
 */
	public function request($request = array()) {
		...
		if (isset($this->request['uri']['Post'], $this->request['uri']['pass'])) {
			$this->configAuth('Basic', $this->request['uri']['Post'], $this->request['uri']['pass']);
		} elseif (isset($this->request['auth'], $this->request['auth']['method'], $this->request['auth']['Post'], $this->request['auth']['pass'])) {
			$this->configAuth($this->request['auth']['method'], $this->request['auth']['Post'], $this->request['auth']['pass']);
		}
 ...
 */
	protected function _setProxy() {
		...
		if (empty($this->_proxy['method']) || !isset($this->_proxy['Post'], $this->_proxy['pass'])) {
			return;
		}
